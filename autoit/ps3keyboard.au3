...
$Form1_1 = GUICreate("PS3����", 1201, 532, 196, 174)
$Label1 = GUICtrlCreateLabel("�˿� COM", 16, 16, 55, 17)
...
$Label2 = GUICtrlCreateLabel("������", 128, 16, 40, 17)
...
$ctrl_comm = GUICtrlCreateButton("����PS3", 256, 16, 75, 25)
$Label3 = GUICtrlCreateLabel("��PS3���룺", 16, 48, 72, 17)
...
$ctrl_okInput = GUICtrlCreateButton("ȷ��", 168, 176, 75, 25)
...
$Label4 = GUICtrlCreateLabel("ֱ�������ֵ:", 16, 216, 79, 17)
$ctrl_okAscii = GUICtrlCreateButton("ȷ��", 168, 216, 75, 25)
$Label5 = GUICtrlCreateLabel("CommSendString", 16, 264, 85, 17)
$ctrl_close = GUICtrlCreateButton("�رմ���", 480, 16, 75, 25)
$ctrl_str = GUICtrlCreateInput("\r\n", 104, 264, 73, 21)
$ctrl_okStr = GUICtrlCreateButton("ȷ��", 192, 264, 75, 25)
...
$Label6 = GUICtrlCreateLabel("ͨ��Cronus����", 16, 336, 85, 17)
...
$Label7 = GUICtrlCreateLabel("ִ�а���˳��", 616, 8, 76, 17)
$ctrl_clearAct = GUICtrlCreateButton("���", 784, 216, 107, 41)
$ctrl_exeAct = GUICtrlCreateButton("ִ��", 784, 272, 105, 41)
$ctrl_actList = GUICtrlCreateList("", 616, 56, 161, 344)
$ctrl_selectAct = GUICtrlCreateButton("��ʼ¼��", 784, 56, 105, 41)
$ctrl_delAct = GUICtrlCreateButton("ɾ��", 784, 163, 105, 41)
$ctrl_saveActList = GUICtrlCreateButton("����Ϊaps3�ļ�", 784, 360, 107, 41)
$Label8 = GUICtrlCreateLabel("Ҫִ�еİ���˳��", 616, 416, 100, 17)
...
$Label9 = GUICtrlCreateLabel("ʱ��ȴ�(��)", 304, 272, 70, 17)
$ctrl_autoContinue = GUICtrlCreateCheckbox("�Զ�����", 784, 320, 97, 17)
$Label10 = GUICtrlCreateLabel("��������", 784, 128, 52, 17)
$ctrl_actTimes = GUICtrlCreateInput("1", 840, 128, 49, 21)
$ctrl_syncOp = GUICtrlCreateCheckbox("ͬʱ����PS3", 784, 104, 97, 17)
...
$ctrl_autoInsWait = GUICtrlCreateCheckbox("¼��ʱ�Զ�����ȴ�ʱ��(����)", 320, 304, 193, 17)
GUICtrlSetState(-1, $GUI_CHECKED)
$ctrl_autoWaitDelay = GUICtrlCreateInput("500", 520, 304, 49, 21)
$ctrl_fileList = GUICtrlCreateList("", 904, 56, 145, 344)
$Label11 = GUICtrlCreateLabel("aps3�ļ�", 904, 32, 51, 17)
$ctrl_fileDel = GUICtrlCreateButton("ɾ��", 1056, 64, 75, 25)
$ctrl_fileOpen = GUICtrlCreateButton("��", 1056, 104, 75, 25)
$ctrl_fileInsertTo = GUICtrlCreateButton("����", 1056, 144, 75, 25)
$ctrl_fileRefresh = GUICtrlCreateButton("ˢ��", 1056, 376, 75, 25)
GUISetState(@SW_SHOW)
...
Func on_comm()
	...
	If $resOpen<>1 Then
		MsgBox(0,"ÉèÖÃ¶Ë¿ÚÊ§°Ü",$sportSetError)
		GUICtrlSetData($ctrl_commStats, "¶Ë¿Ú"&$setport&"ÉèÖÃÊ§°Ü")
	Else
		GUICtrlSetData($ctrl_commStats, "¶Ë¿Ú"&$setport&"ÉèÖÃ³É¹¦")
	EndIf
EndFunc
...
Func Action($action)
	If $ACT_SELECT_MODE Then
		If $action<>"" Then
			...
			actListToStr()
			;Èç¹û¡°Í¬Ê±²Ù×÷PS3¡±ÊÇ¹´Ñ¡µÄ£¬ÄÇÃ´¾ÍÖ´ÐÐ¶¯×÷
...
Func SetExeing($bool)
	If $bool Then
		$ACT_EXEING = True
		GUICtrlSetData($ctrl_exeAct,"Í£Ö¹")
	...
	Else
		$ACT_EXEING = False
		GUICtrlSetData($ctrl_exeAct,"Ö´ÐÐ")
